          ...
          <div className="flex gap-4 mb-8 border-b border-cyan-500/20">
            <button
              ...
              className={`px-4 py-2 font-semibold transition-colors ${
                activeTab === "profile" ? "text-cyan-400 border-b-2 border-cyan-400" : "text-gray-400 hover:text-white"
              }`}
            >
              Profile
            </button>
            <button
              ...
              className={`px-4 py-2 font-semibold transition-colors ${
                activeTab === "account" ? "text-cyan-400 border-b-2 border-cyan-400" : "text-gray-400 hover:text-white"
              }`}
            >
              Account
            </button>
