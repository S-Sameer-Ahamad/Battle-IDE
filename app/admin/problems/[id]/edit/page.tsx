...
export default function EditProblemPage() {
  ...
  const fetchProblem = async () => {
    try {
      ...
      const parsedTestCases = JSON.parse(problem.testCases)
  ...
  const onSubmit = async (data: ProblemFormData) => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Failed to update problem. Please try again.")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <main className="pt-20 px-4 sm:px-6 lg:px-8 pb-20">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-4xl font-bold text-white">Edit Problem</h1>
            <Link
              href="/admin/problems"
